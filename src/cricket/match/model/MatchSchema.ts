...
export const MatchSchema = new mongoose.Schema({
    ...
    squad1: { type: mongoose.Schema.Types.ObjectId, ref: 'Squad', autopopulate: { select: ['team', 'players', 'innings1', 'innings2'] } },
    squad2: { type: mongoose.Schema.Types.ObjectId, ref: 'Squad', autopopulate: { select: ['team', 'players', 'innings1', 'innings2'] } },
    matchUrl: String,
